...
version = property("player_popup_emotes_version")!!

group = "jbro.cobblemon"

base { archivesName.set("player-popup-emotes") }
...
val unitTest by tasks.registering(JavaExec::class) {
    group = "verification"
    description = "Runs Player Popup Emotes JUnit tests without the Gradle test worker."
