...
internal object LocalDamageHpTransfer {
    fun fraction(damage: Double, ratio: Double, actor: BattlePokemonStateView?, target: BattlePokemonStateView?): Double {
        ...
        val transferred = if (wholeDamage.toDouble() / targetHp.minimum == damage) {
