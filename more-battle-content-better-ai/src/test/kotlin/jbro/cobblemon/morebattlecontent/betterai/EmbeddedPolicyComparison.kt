...
internal object EmbeddedPolicyComparison {
    ...
    fun tuning(name: String) = when (name) {
        ...
        "CURRENT_NO_MOVE_USAGE" -> LocalDecisionTuning.CURRENT.copy(
            id = "current_no_move_usage", lookaheadMoveHypotheses = false)
        ...
        else -> error("Supported arms: CURRENT, LEGACY, CURRENT_UNCAPPED_LEAF, CURRENT_TEAM_COVERAGE, CURRENT_NO_MOVE_USAGE, CURRENT_PUBLIC_MOVE_HYPOTHESES, CURRENT_PUBLIC_MOVE_HYPOTHESES_CAP3, CURRENT_PUBLIC_MOVE_HYPOTHESES_CAP3_PRIORITY or CURRENT_PUBLIC_MOVE_HYPOTHESES_CAP3_PRIORITY_CONDITIONS")
    }
