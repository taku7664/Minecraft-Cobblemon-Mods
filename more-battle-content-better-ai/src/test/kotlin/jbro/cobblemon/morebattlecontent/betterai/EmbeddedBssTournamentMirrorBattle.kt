...
internal object EmbeddedBssTournamentMirrorBattle {
    ...
    fun main(args: Array<String>) {
        ...
        val summary = JsonObject().apply {
            ...
            addProperty("comparisonTournament", "Battle Stadium Singles 2025 Invitational, Regulation J")
            addProperty("comparisonReplay", "https://replay.pokemonshowdown.com/smogtours-gen9bssregj-895354")
